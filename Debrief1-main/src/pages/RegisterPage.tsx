...
export const RegisterPage: React.FC<{ onSwitchToLogin: () => void }> = ({ onSwitchToLogin }) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!ok) setError('Registration failed. Please try again (password must be at least 6 characters).');
    setLoading(false);
  };
    ...
    <div className="min-h-screen bg-[#F7F6F3] flex items-center justify-center p-4">
      ...
      >
        ...
        <div className="text-center mb-10">
          ...
          <p className="text-sm text-gray-500 mt-1">Join Debrief today</p>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-8">
          ...
          <p className="text-xs text-gray-500 mt-5 text-center">
            ...
            <button type="button" onClick={onSwitchToLogin} className="text-gray-900 font-semibold hover:underline">
              Sign in
            </button>
          </p>
        </div>
